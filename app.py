...
cloud_info = {
    ...
    "Altostratus": {
        "和名": "高層雲（こうそううん）",
        "特徴": "灰色または青灰色のベール状雲。太陽や月がぼんやり透ける。雨を降らせる雲の前触れとなることがある。",
        "高度分類": "中層雲（2,000〜7,000m）"
    },
    "Capcloud": {
        "和名": "( ﾟДﾟ) 笠雲（かさくも）",
    ...
    "Cirrocumulus": {
        "和名": "巻積雲（けんせきうん）",
        "特徴": "小さい白い斑点状の雲が魚の鱗のように並ぶ。天気が崩れる前兆として現れることがある。",
        "高度分類": "上層雲（5,000〜13,000m）"
    },
    "Cirrostratus": {
        "和名": "巻層雲（けんそううん）",
        "特徴": "薄いベールのような雲で、暈（かさ）が見えることが多い。低気圧が近づいているサインで、雨の前兆となることがある。",
        "高度分類": "上層雲（5,000〜13,000m）"
    },
    "Cirrus": {
        "和名": "巻雲（けんうん）",
        "特徴": "白く繊細なまっすぐ広がっている場合：雨が降りやすい、乱れている場合：晴れやすい傾向、筋状の場合：天気が崩れる前兆",
        "高度分類": "上層雲（5,000〜13,000m）"
    },
    "Cumulonimbus": {
        "和名": "積乱雲（せきらんうん）",
        "特徴": "入道雲とも呼ばれ、雷雨や突風を伴うことがある。夏の夕立や雷雨の原因となる。",
        "高度分類": "対流雲（地上〜13,000m）"
    },
    "Cumulus": {
        "和名": "積雲（せきうん）",
    ...
    "Nimbostratus": {
        "和名": "乱層雲（らんそううん）",
        "特徴": "厚く広がり長時間の雨や雪を降らせる。前線や低気圧の近くで発生する。",
        "高度分類": "低層雲（〜2,000m）"
    },
    "Shelf": {
        "和名": "( ﾟДﾟ) 棚雲（たなぐも）",
    ...
    "Stratocumulus": {
        "和名": "層積雲（そうせきうん）",
        "特徴": "灰色や白色の塊が一面に広がる雲。雨を降らせることは少ないが、空を覆うとどんよりとした天気になる。",
        "高度分類": "低層雲（〜2,000m）"
    },
    "Stratus": {
        "和名": "層雲（そううん）",
        "特徴": "一様に広がる灰色の雲。小雨や霧雨を伴うことがある。山間部では霧として見られる。",
        "高度分類": "低層雲（〜2,000m）"
    }
}
